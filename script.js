window.onload = () => {
    ...
    makeStory({
        year: "1951",
        gen: "Завершено возведение Участка 147."
    });
    makeStory({
        year: "1970",
    ...
    makeStory({
        year: "1977",
        mem: "Создание *OLS-34* — препаратов, способных временно повысить ИКС человека. Прорыв в борьбе с меметическими угрозами. См. [[[sandbox:successful-overdose|Удачный передоз]]]",
    });
    makeStory({
        year: "1978",
    ...
    makeStory({
        year: "2020",
        epi: "Печальный конец проекта *<<ФЛАММАРИОН>>*. Последний известный <<ИНФОШТОРМ>>. Образование зоны отчуждения на Дальнем Востоке. См. [[[SCP-1470-RU]]]",
    });
}
